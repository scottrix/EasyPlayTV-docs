...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { href: "pages/path-migration.html",  label: "Path & migration log", tags: "history strm plugin migration exclude" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "files/movies_db-py.html",     label: "movies_db.py",    tags: "movie listing db query" },
      { href: "files/series_db-py.html",     label: "series_db.py",    tags: "series listing db query" },
